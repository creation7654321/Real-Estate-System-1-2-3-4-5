 ...
 * @final
 */
class AppendStream implements \EasyWPSMTP\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\EasyWPSMTP\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
