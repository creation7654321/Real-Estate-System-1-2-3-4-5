...
class StreamWrapper
{
     ...
     */
    public static function getResource(\EasyWPSMTP\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\EasyWPSMTP\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
