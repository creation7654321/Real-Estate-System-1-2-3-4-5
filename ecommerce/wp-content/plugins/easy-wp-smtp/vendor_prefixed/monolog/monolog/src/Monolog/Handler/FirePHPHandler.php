...
use EasyWPSMTP\Vendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \EasyWPSMTP\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \EasyWPSMTP\Vendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
