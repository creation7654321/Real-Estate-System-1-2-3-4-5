 ...
 */
class RotatingFileHandler extends \EasyWPSMTP\Vendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \EasyWPSMTP\Vendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \EasyWPSMTP\Vendor\Monolog\Utils::canonicalizePath($filename);
