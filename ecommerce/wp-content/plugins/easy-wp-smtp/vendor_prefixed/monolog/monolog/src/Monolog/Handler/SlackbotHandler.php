 ...
 */
class SlackbotHandler extends \EasyWPSMTP\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \EasyWPSMTP\Vendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
